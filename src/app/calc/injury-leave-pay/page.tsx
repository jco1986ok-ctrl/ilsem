...
export const metadata: Metadata = {
  ...
  description:
    '산재로 일을 못하는 동안 받을 수 있는 휴업급여를 계산해보세요. 평균임금의 70% 기준, 저소득 근로자 보호, 고령자 감액까지 2026년 최신 법령을 반영한 정확한 계산기입니다.',
  keywords: [
    '산재 휴업급여 계산기',
    '휴업급여 계산',
    '산재보험 휴업급여',
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-slate-500 mt-0.5 text-sm">
              산재보험법 제52조 기준 · 2026년 최저·최고 보상기준금액 자동 반영
            </p>
          </div>
        </div>
        <div className="flex flex-wrap gap-2">
          {['평균임금 × 70%', '최저·최고 보상기준금액', '고령자 감액', '2026년 기준'].map((tag) => (
            <span
              key={tag}
...
function SeoContent() {
  return (
    <article className="bg-white border border-gray-200 rounded-xl p-6 sm:p-8 space-y-6 text-sm text-gray-700 leading-relaxed">
      ...
      <section className="space-y-3">
        ...
        <div className="space-y-2">
          ...
          <p>
            ...
            2026년 기준 최저보상기준금액은 82,560원(최저시급 10,320원 × 8시간)이므로, 하한선은 <strong>66,048원(82,560원 × 80%)</strong>입니다.
        ...
        <div className="space-y-2">
          ...
          <p>
            1일 휴업급여(평균임금의 70%)가 <strong>최고보상기준금액의 70%(268,299원 × 70% = 187,809원)</strong>를 초과할 수 없습니다.
            고소득 근로자의 경우 평균임금의 70%가 상한선을 초과하더라도 187,809원만 지급됩니다.
      ...
      <section className="space-y-2">
        <h3 className="font-bold text-gray-900">8. 2026년 보상기준금액 기준</h3>
        <ul className="list-disc list-inside space-y-1.5 pl-2">
          <li>2026년 최저시급: 10,320원</li>
          <li>1일 최저보상기준금액: 82,560원 (10,320원 × 8시간)</li>
          <li>1일 최저 휴업급여 하한: 66,048원 (82,560원 × 80%)</li>
          <li>1일 최고보상기준금액: 268,299원</li>
          <li>1일 최고 휴업급여 상한: 187,809원 (268,299원 × 70%)</li>
      ...
      <p className="text-xs text-gray-400 pt-2 border-t border-gray-100">
        ※ 본 계산기는 2026년 기준 산재보험법 제52조 및 고용노동부 고시 금액을 기반으로 제공되며, 참고용입니다.
